    ...
    try {
      ...
      if (isNaN(price15g)) {
        toast({
          ...
          description: "Price 15g must be a valid number",
          variant: "destructive"
        });
      ...
      if (isNaN(price20g)) {
        toast({
          title: "Validation failed",
          description: "Price 20g must be a valid number",
          variant: "destructive"
        });
        setUploadingImages(false);
        return;
      ...
      if (price !== null && isNaN(price)) {
        toast({
          title: "Validation failed",
          description: "Price must be a valid number or left empty",
          variant: "destructive"
        });
        setUploadingImages(false);
        return;
      ...
      if (minOrderQuantity !== null && isNaN(minOrderQuantity)) {
        toast({
          title: "Validation failed",
          description: "Min order quantity must be a valid number or left empty",
          variant: "destructive"
        });
        setUploadingImages(false);
        return;
