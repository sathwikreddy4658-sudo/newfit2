      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-6 mb-6">
          ...
          {order.address && (
            <div className="flex items-start gap-2 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm text-muted-foreground font-semibold">Delivery Address</p>
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="flex justify-between items-center pt-4 border-t mt-4">
            ...
            <span className="text-2xl font-bold text-primary">₹{parseFloat(order.total_price).toFixed(2)}</span>
          </div>
        </Card>

        {/* Payment Method */}
        <Card className="p-6 mb-6 bg-blue-50 border-blue-200">
          <p className="text-sm text-blue-900 font-semibold mb-2">Payment Method</p>
